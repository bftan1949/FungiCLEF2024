...
class SyncBatchNormAct(nn.SyncBatchNorm):
    ...
    # This is a quick workaround to support SyncBatchNorm for mytimm BatchNormAct2d layers
    # but ONLY when used in conjunction with the mytimm conversion function below.
