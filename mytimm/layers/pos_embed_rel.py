...
def gen_relative_log_coords(
    ...
    # as per official swin-v2 impl, supporting mytimm specific 'cr' log coords as well
...
class RelPosMlp(nn.Module):
    ...
    This impl covers the 'swin' implementation as well as two mytimm specific modes ('cr', and 'rw')
    """
    def __init__(
            self,
            window_size,
