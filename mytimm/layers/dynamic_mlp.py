...
class Dynamic_MLP_A(nn.Module):
    ...
    def forward(self, img_fea, loc_fea):
        ...
        weight = weight.view(-1, self.inplanes, self.planes).contiguous()
...
class Dynamic_MLP_B(nn.Module):
    ...
    def forward(self, img_fea, loc_fea):
        ...
        weight22 = self.conv22(weight21).view(-1, self.inplanes, self.planes).contiguous()
...
def get_dynamic_mlp(inplanes, mlp_d, mlp_h, mlp_n, mlp_type):
