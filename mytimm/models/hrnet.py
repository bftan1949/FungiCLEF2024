...
from mytimm.layers import create_classifier
...
default_cfgs = generate_default_cfgs({
    'hrnet_w18_small.gluon_in1k': _cfg(hf_hub_id='mytimm/', interpolation='bicubic'),
    'hrnet_w18_small.ms_in1k': _cfg(hf_hub_id='mytimm/'),
    'hrnet_w18_small_v2.gluon_in1k': _cfg(hf_hub_id='mytimm/', interpolation='bicubic'),
    'hrnet_w18_small_v2.ms_in1k': _cfg(hf_hub_id='mytimm/'),
    'hrnet_w18.ms_aug_in1k': _cfg(
        hf_hub_id='mytimm/',
        crop_pct=0.95,
    ),
    'hrnet_w18.ms_in1k': _cfg(hf_hub_id='mytimm/'),
    'hrnet_w30.ms_in1k': _cfg(hf_hub_id='mytimm/'),
    'hrnet_w32.ms_in1k': _cfg(hf_hub_id='mytimm/'),
    'hrnet_w40.ms_in1k': _cfg(hf_hub_id='mytimm/'),
    'hrnet_w44.ms_in1k': _cfg(hf_hub_id='mytimm/'),
    'hrnet_w48.ms_in1k': _cfg(hf_hub_id='mytimm/'),
    'hrnet_w64.ms_in1k': _cfg(hf_hub_id='mytimm/'),
