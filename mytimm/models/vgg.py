...
from mytimm.layers import ClassifierHead
...
default_cfgs = generate_default_cfgs({
    'vgg11.tv_in1k': _cfg(hf_hub_id='mytimm/'),
    'vgg13.tv_in1k': _cfg(hf_hub_id='mytimm/'),
    'vgg16.tv_in1k': _cfg(hf_hub_id='mytimm/'),
    'vgg19.tv_in1k': _cfg(hf_hub_id='mytimm/'),
    'vgg11_bn.tv_in1k': _cfg(hf_hub_id='mytimm/'),
    'vgg13_bn.tv_in1k': _cfg(hf_hub_id='mytimm/'),
    'vgg16_bn.tv_in1k': _cfg(hf_hub_id='mytimm/'),
    'vgg19_bn.tv_in1k': _cfg(hf_hub_id='mytimm/'),
})
