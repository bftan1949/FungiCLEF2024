...
from mytimm.layers import PatchEmbed, Mlp, DropPath, to_2tuple, trunc_normal_, _assert, LayerNorm
...
default_cfgs = generate_default_cfgs({
    'coat_tiny.in1k': _cfg_coat(hf_hub_id='mytimm/'),
    'coat_mini.in1k': _cfg_coat(hf_hub_id='mytimm/'),
    'coat_small.in1k': _cfg_coat(hf_hub_id='mytimm/'),
    'coat_lite_tiny.in1k': _cfg_coat(hf_hub_id='mytimm/'),
    'coat_lite_mini.in1k': _cfg_coat(hf_hub_id='mytimm/'),
    'coat_lite_small.in1k': _cfg_coat(hf_hub_id='mytimm/'),
    'coat_lite_medium.in1k': _cfg_coat(hf_hub_id='mytimm/'),
