...
from mytimm.layers import ClassifierHead, ConvNormAct, BatchNormAct2d, DropPath, AvgPool2dSame, \
...
default_cfgs = generate_default_cfgs({
    ...
    'gernet_s.idstcv_in1k': _cfg(hf_hub_id='mytimm/'),
    'gernet_m.idstcv_in1k': _cfg(hf_hub_id='mytimm/'),
    'gernet_l.idstcv_in1k': _cfg(hf_hub_id='mytimm/', input_size=(3, 256, 256), pool_size=(8, 8)),
    ...
    # custom `mytimm` specific RegNetZ inspired models w/ different sizing from paper
