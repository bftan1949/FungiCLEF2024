...
from mytimm.layers import ClassifierHead, ConvNormAct, DropPath, PadType, create_conv2d, get_norm_act_layer
from mytimm.layers.helpers import to_3tuple
...
default_cfgs = generate_default_cfgs({
    ...
    'xception41.tf_in1k': _cfg(hf_hub_id='mytimm/'),
    'xception65.tf_in1k': _cfg(hf_hub_id='mytimm/'),
    'xception71.tf_in1k': _cfg(hf_hub_id='mytimm/'),
