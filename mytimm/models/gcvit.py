...
From scratch implementation of GCViT in the style of mytimm swin_transformer_v2_cr.py
...
from mytimm.layers import DropPath, to_2tuple, to_ntuple, Mlp, ClassifierHead, LayerNorm2d, \
