...
from mytimm.layers import to_2tuple, make_divisible, GroupNorm1, ConvMlp, DropPath, is_exportable
...
default_cfgs = generate_default_cfgs({
    'mobilevit_xxs.cvnets_in1k': _cfg(hf_hub_id='mytimm/'),
    'mobilevit_xs.cvnets_in1k': _cfg(hf_hub_id='mytimm/'),
    'mobilevit_s.cvnets_in1k': _cfg(hf_hub_id='mytimm/'),
