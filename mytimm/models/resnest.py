...
from mytimm.layers import SplitAttn
...
default_cfgs = generate_default_cfgs({
    'resnest14d.gluon_in1k': _cfg(hf_hub_id='mytimm/'),
    'resnest26d.gluon_in1k': _cfg(hf_hub_id='mytimm/'),
    'resnest50d.in1k': _cfg(hf_hub_id='mytimm/'),
