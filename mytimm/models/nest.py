...
from mytimm.layers import PatchEmbed, Mlp, DropPath, create_classifier, trunc_normal_, _assert
from mytimm.layers import create_conv2d, create_pool2d, to_ntuple, use_fused_attn, LayerNorm
...
default_cfgs = generate_default_cfgs({
    ...
    'nest_base_jx.goog_in1k': _cfg(hf_hub_id='mytimm/'),
    'nest_small_jx.goog_in1k': _cfg(hf_hub_id='mytimm/'),
    'nest_tiny_jx.goog_in1k': _cfg(hf_hub_id='mytimm/'),
})
