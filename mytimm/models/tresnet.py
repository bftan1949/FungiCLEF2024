...
from mytimm.layers import SpaceToDepth, BlurPool2d, ClassifierHead, SEModule,\
...
default_cfgs = generate_default_cfgs({
    'tresnet_m.miil_in21k_ft_in1k': _cfg(hf_hub_id='mytimm/'),
    'tresnet_m.miil_in21k': _cfg(hf_hub_id='mytimm/', num_classes=11221),
    'tresnet_m.miil_in1k': _cfg(hf_hub_id='mytimm/'),
    'tresnet_l.miil_in1k': _cfg(hf_hub_id='mytimm/'),
    'tresnet_xl.miil_in1k': _cfg(hf_hub_id='mytimm/'),
    ...
    'tresnet_v2_l.miil_in21k_ft_in1k': _cfg(hf_hub_id='mytimm/'),
    'tresnet_v2_l.miil_in21k': _cfg(hf_hub_id='mytimm/', num_classes=11221),
})
