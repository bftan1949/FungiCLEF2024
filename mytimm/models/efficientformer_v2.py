...
Significantly refactored and cleaned up for mytimm from original at: https://github.com/snap-research/EfficientFormer

Original code licensed Apache 2.0, Copyright (c) 2022 Snap Inc.

Modifications and mytimm support by / Copyright 2023, Ross Wightman
"""
import math
...
from mytimm.layers import create_conv2d, create_norm_layer, get_act_layer, get_norm_layer, ConvNormAct
from mytimm.layers import DropPath, trunc_normal_, to_2tuple, to_ntuple, ndgrid
