...
from mytimm.layers import SelectiveKernel, ConvNormAct, create_attn
...
default_cfgs = generate_default_cfgs({
    'skresnet18.ra_in1k': _cfg(hf_hub_id='mytimm/'),
    'skresnet34.ra_in1k': _cfg(hf_hub_id='mytimm/'),
    'skresnet50.untrained': _cfg(),
    'skresnet50d.untrained': _cfg(
        first_conv='conv1.0'),
    'skresnext50_32x4d.ra_in1k': _cfg(hf_hub_id='mytimm/'),
})
