...
from mytimm.layers import DropBlock2d, DropPath, AvgPool2dSame, BlurPool2d, GroupNorm, LayerType, create_attn, \
...
default_cfgs = generate_default_cfgs({
    # ResNet and Wide ResNet trained w/ mytimm (RSB paper and others)
    ...
    # ResNeXt trained in mytimm (RSB paper and others)
