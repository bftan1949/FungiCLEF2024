...
default_cfgs = generate_default_cfgs({
    'hardcorenas_a.miil_green_in1k': _cfg(hf_hub_id='mytimm/'),
    'hardcorenas_b.miil_green_in1k': _cfg(hf_hub_id='mytimm/'),
    'hardcorenas_c.miil_green_in1k': _cfg(hf_hub_id='mytimm/'),
    'hardcorenas_d.miil_green_in1k': _cfg(hf_hub_id='mytimm/'),
    'hardcorenas_e.miil_green_in1k': _cfg(hf_hub_id='mytimm/'),
    'hardcorenas_f.miil_green_in1k': _cfg(hf_hub_id='mytimm/'),
})
