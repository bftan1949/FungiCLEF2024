...
from mytimm.layers import Mlp, DropPath, to_2tuple, trunc_normal_, use_fused_attn
...
default_cfgs = generate_default_cfgs({
    'twins_pcpvt_small.in1k': _cfg(hf_hub_id='mytimm/'),
    'twins_pcpvt_base.in1k': _cfg(hf_hub_id='mytimm/'),
    'twins_pcpvt_large.in1k': _cfg(hf_hub_id='mytimm/'),
    'twins_svt_small.in1k': _cfg(hf_hub_id='mytimm/'),
    'twins_svt_base.in1k': _cfg(hf_hub_id='mytimm/'),
    'twins_svt_large.in1k': _cfg(hf_hub_id='mytimm/'),
})
