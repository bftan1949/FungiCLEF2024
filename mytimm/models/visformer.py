...
from mytimm.layers import to_2tuple, trunc_normal_, DropPath, PatchEmbed, LayerNorm2d, create_classifier, use_fused_attn
...
default_cfgs = generate_default_cfgs({
    'visformer_tiny.in1k': _cfg(hf_hub_id='mytimm/'),
    'visformer_small.in1k': _cfg(hf_hub_id='mytimm/'),
})
