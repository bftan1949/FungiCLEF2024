...
default_cfgs = generate_default_cfgs({
    'dla34.in1k': _cfg(hf_hub_id='mytimm/'),
    'dla46_c.in1k': _cfg(hf_hub_id='mytimm/'),
    'dla46x_c.in1k': _cfg(hf_hub_id='mytimm/'),
    'dla60x_c.in1k': _cfg(hf_hub_id='mytimm/'),
    'dla60.in1k': _cfg(hf_hub_id='mytimm/'),
    'dla60x.in1k': _cfg(hf_hub_id='mytimm/'),
    'dla102.in1k': _cfg(hf_hub_id='mytimm/'),
    'dla102x.in1k': _cfg(hf_hub_id='mytimm/'),
    'dla102x2.in1k': _cfg(hf_hub_id='mytimm/'),
    'dla169.in1k': _cfg(hf_hub_id='mytimm/'),
    'dla60_res2net.in1k': _cfg(hf_hub_id='mytimm/'),
    'dla60_res2next.in1k': _cfg(hf_hub_id='mytimm/'),
})
