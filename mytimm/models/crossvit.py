...
from mytimm.layers import DropPath, to_2tuple, trunc_normal_, _assert
...
default_cfgs = generate_default_cfgs({
    'crossvit_15_240.in1k': _cfg(hf_hub_id='mytimm/'),
    ...
    'crossvit_18_240.in1k': _cfg(hf_hub_id='mytimm/'),
    ...
    'crossvit_9_240.in1k': _cfg(hf_hub_id='mytimm/'),
    'crossvit_9_dagger_240.in1k': _cfg(
        hf_hub_id='mytimm/',
        first_conv=('patch_embed.0.proj.0', 'patch_embed.1.proj.0'),
    ),
    'crossvit_base_240.in1k': _cfg(hf_hub_id='mytimm/'),
    'crossvit_small_240.in1k': _cfg(hf_hub_id='mytimm/'),
    'crossvit_tiny_240.in1k': _cfg(hf_hub_id='mytimm/'),
})
