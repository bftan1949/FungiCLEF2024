...
adapted for mytimm by Fredo Guan and Ross Wightman.
...
from mytimm.layers import trunc_normal_, DropPath, SelectAdaptivePool2d, GroupNorm1, LayerNorm, LayerNorm2d, Mlp, \
    use_fused_attn
...
default_cfgs = generate_default_cfgs({
    ...
    'poolformerv2_s12.sail_in1k': _cfg(hf_hub_id='mytimm/'),
    'poolformerv2_s24.sail_in1k': _cfg(hf_hub_id='mytimm/'),
    'poolformerv2_s36.sail_in1k': _cfg(hf_hub_id='mytimm/'),
    'poolformerv2_m36.sail_in1k': _cfg(hf_hub_id='mytimm/'),
    'poolformerv2_m48.sail_in1k': _cfg(hf_hub_id='mytimm/'),
