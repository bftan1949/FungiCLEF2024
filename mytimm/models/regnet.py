...
A number of custom mytimm model definitions additions including:
...
from mytimm.layers import ClassifierHead, AvgPool2dSame, ConvNormAct, SEModule, DropPath, GroupNormAct
from mytimm.layers import get_act_layer, get_norm_act_layer, create_conv2d, make_divisible
...
default_cfgs = generate_default_cfgs({
    ...
    'regnety_120.sw_in12k_ft_in1k': _cfg(hf_hub_id='mytimm/'),
    'regnety_160.sw_in12k_ft_in1k': _cfg(hf_hub_id='mytimm/'),
    'regnety_160.lion_in12k_ft_in1k': _cfg(hf_hub_id='mytimm/'),

    # mytimm in12k pretrain
    ...
    # mytimm custom arch (v and z guess) + trained models
    ...
    'regnety_160.deit_in1k': _cfg(
        hf_hub_id='mytimm/', url='https://dl.fbaipublicfiles.com/deit/regnety_160-a5fe301d.pth'),
    ...
    'regnetx_002.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnetx_004.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnetx_006.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnetx_008.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnetx_016.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnetx_032.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnetx_040.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnetx_064.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnetx_080.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnetx_120.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnetx_160.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnetx_320.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),

    'regnety_002.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnety_004.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnety_006.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnety_008.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnety_016.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnety_032.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnety_040.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnety_064.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnety_080.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnety_120.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnety_160.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
    'regnety_320.pycls_in1k': _cfgpyc(hf_hub_id='mytimm/'),
})
