...
Modifications and mytimm support by / Copyright 2022, Ross Wightman
"""
...
from mytimm.layers import DropPath, to_2tuple, to_ntuple, trunc_normal_, LayerNorm, use_fused_attn
...
def _checkpoint_filter_fn(state_dict, model):
    """ Remap original checkpoints -> mytimm """
...
default_cfgs = generate_default_cfgs({
    'pvt_v2_b0.in1k': _cfg(hf_hub_id='mytimm/'),
    'pvt_v2_b1.in1k': _cfg(hf_hub_id='mytimm/'),
    'pvt_v2_b2.in1k': _cfg(hf_hub_id='mytimm/'),
    'pvt_v2_b3.in1k': _cfg(hf_hub_id='mytimm/'),
    'pvt_v2_b4.in1k': _cfg(hf_hub_id='mytimm/'),
    'pvt_v2_b5.in1k': _cfg(hf_hub_id='mytimm/'),
    'pvt_v2_b2_li.in1k': _cfg(hf_hub_id='mytimm/'),
})
