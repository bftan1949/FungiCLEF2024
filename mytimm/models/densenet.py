...
from mytimm.layers import BatchNormAct2d, get_norm_act_layer, BlurPool2d, create_classifier
...
default_cfgs = generate_default_cfgs({
    ...
    'densenet121.tv_in1k': _cfg(hf_hub_id='mytimm/'),
    'densenet169.tv_in1k': _cfg(hf_hub_id='mytimm/'),
    'densenet201.tv_in1k': _cfg(hf_hub_id='mytimm/'),
    'densenet161.tv_in1k': _cfg(hf_hub_id='mytimm/'),
})
