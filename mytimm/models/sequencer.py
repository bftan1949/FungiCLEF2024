...
from mytimm.data import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD, DEFAULT_CROP_PCT
from mytimm.layers import lecun_normal_, DropPath, Mlp, PatchEmbed, ClassifierHead
...
default_cfgs = generate_default_cfgs({
    'sequencer2d_s.in1k': _cfg(hf_hub_id='mytimm/'),
    'sequencer2d_m.in1k': _cfg(hf_hub_id='mytimm/'),
    'sequencer2d_l.in1k': _cfg(hf_hub_id='mytimm/'),
})
