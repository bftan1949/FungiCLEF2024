...
from mytimm.layers import BatchNormAct2d, ConvNormAct, create_conv2d, create_classifier, get_norm_act_layer
...
default_cfgs = generate_default_cfgs({
    ...
    'dpn68.mx_in1k': _cfg(hf_hub_id='mytimm/'),
    'dpn68b.ra_in1k': _cfg(
        hf_hub_id='mytimm/',
        mean=IMAGENET_DEFAULT_MEAN, std=IMAGENET_DEFAULT_STD,
        crop_pct=0.95, test_input_size=(3, 288, 288), test_crop_pct=1.0),
    'dpn68b.mx_in1k': _cfg(hf_hub_id='mytimm/'),
    'dpn92.mx_in1k': _cfg(hf_hub_id='mytimm/'),
    'dpn98.mx_in1k': _cfg(hf_hub_id='mytimm/'),
    'dpn131.mx_in1k': _cfg(hf_hub_id='mytimm/'),
    'dpn107.mx_in1k': _cfg(hf_hub_id='mytimm/')
})
