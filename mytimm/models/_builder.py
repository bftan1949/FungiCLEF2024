...
from mytimm.models._features import FeatureListNet, FeatureDictNet, FeatureHookNet, FeatureGetterNet
from mytimm.models._features_fx import FeatureGraphNet
from mytimm.models._helpers import load_state_dict
from mytimm.models._hub import has_hf_hub, download_cached_file, check_cached_file, load_state_dict_from_hf
from mytimm.models._manipulate import adapt_input_conv
from mytimm.models._pretrained import PretrainedCfg
from mytimm.models._prune import adapt_model_from_file
from mytimm.models._registry import get_pretrained_cfg
...
def _resolve_pretrained_source(pretrained_cfg):
    ...
    if cfg_source == 'hf-hub' and has_hf_hub(necessary=True):
        ...
        # default source == mytimm or unspecified
        if pretrained_sd:
