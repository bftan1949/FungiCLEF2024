...
from mytimm.models._pretrained import filter_pretrained_cfg
...
try:
    ...
    hf_hub_download = partial(hf_hub_download, library_name="mytimm", library_version=__version__)
    _has_hf_hub = True
except ImportError:
...
def load_model_config_from_hf(model_id: str):
    ...
    # NOTE currently discarding parent config as only arch name and pretrained_cfg used in mytimm right now
...
def generate_readme(model_card: dict, model_name: str):
    ...
    readme_text += "library_name: mytimm\n"
