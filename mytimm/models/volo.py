...
Modifications and additions for mytimm by / Copyright 2022, Ross Wightman
"""
...
from mytimm.layers import DropPath, Mlp, to_2tuple, to_ntuple, trunc_normal_, use_fused_attn
...
class VOLODynamicMLP(nn.Module):
    """
    Vision Outlooker, the main class of our model
    """
...
def _create_volo(variant, pretrained=False, model_cls=None, **kwargs):
...
@register_model
def volo_d4_dynamic_mlp_448(pretrained=False, **kwargs) -> VOLO:
    """ VOLO-D4 model, Params: 193M """
    model_args = dict(layers=(8, 8, 16, 4), embed_dims=(384, 768, 768, 768), num_heads=(12, 16, 16, 16), **kwargs)
    model = _create_volo('volo_d4_448', model_cls=VOLODynamicMLP, pretrained=pretrained, **model_args)
    return model
