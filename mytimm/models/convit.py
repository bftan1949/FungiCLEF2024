...
from mytimm.layers import DropPath, trunc_normal_, PatchEmbed, Mlp, LayerNorm
...
default_cfgs = generate_default_cfgs({
    # ConViT
    'convit_tiny.fb_in1k': _cfg(hf_hub_id='mytimm/'),
    'convit_small.fb_in1k': _cfg(hf_hub_id='mytimm/'),
    'convit_base.fb_in1k': _cfg(hf_hub_id='mytimm/')
})
