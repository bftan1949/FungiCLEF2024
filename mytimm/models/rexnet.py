...
from mytimm.layers import ClassifierHead, create_act_layer, ConvNormAct, DropPath, make_divisible, SEModule
...
default_cfgs = generate_default_cfgs({
    'rexnet_100.nav_in1k': _cfg(hf_hub_id='mytimm/'),
    'rexnet_130.nav_in1k': _cfg(hf_hub_id='mytimm/'),
    'rexnet_150.nav_in1k': _cfg(hf_hub_id='mytimm/'),
    'rexnet_200.nav_in1k': _cfg(hf_hub_id='mytimm/'),
    'rexnet_300.nav_in1k': _cfg(hf_hub_id='mytimm/'),
